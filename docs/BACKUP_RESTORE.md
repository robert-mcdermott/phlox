...
The current head is `0006_projects`, adding private projects, per-turn context records, and
...
run/replay/action tables. Revisions `0001_wave3`, `0002_ledger_width`, `0003_runs`, `0004_sources`, and `0005_ingestion` remain
