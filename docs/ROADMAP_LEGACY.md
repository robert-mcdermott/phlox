...
> **Historical plan, archived 2026-09-07.** The original content below is preserved as
> delivery history and may contain outdated claims. Use [ROADMAP.md](ROADMAP.md) for the
> active improvement plan and [CODEBASE_REVIEW.md](CODEBASE_REVIEW.md) for its evidence.
